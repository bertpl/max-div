...
class SolverState:
    ...
    def __init__(
        ...
        :param con_indices: (np.ndarray[np.int32] | None) 1d array with all indices per constraint
                                                                     (as generated by _build_array_repr)
        :param item_con_indices: (np.ndarray[np.int32] | None) 1d array with the transposed membership
                                                                     (as generated by _build_array_repr)
        ...
        self._item_con_indices = item_con_indices  # READ-ONLY
    ...
    def copy(self) -> SolverState:
        ...
        return SolverState(
            ...
            item_con_indices=self._item_con_indices.copy(),
    ...
    @cached_property
    def item_con_indices(self) -> NDArray[np.int32]:
        """Return the transposed constraint membership array (item -> ascending constraint ids)."""
        return self._item_con_indices  # should not be modified (!)
