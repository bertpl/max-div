...
`_preprocess` is the one place a metric's vectors are put in the form its pair function reads.
"""
...
from ._preprocess import normalize_rows, preprocess_vectors, validate_cosine_vectors, validate_vector_layout
