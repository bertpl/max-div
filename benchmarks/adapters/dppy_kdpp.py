...
class DppyKDpp(SelectionAdapter):
    ...
    A DPP is a distribution over diverse subsets, not an optimizer, so the selection is a single
    draw. The likelihood kernel is a materialized n x n RBF matrix with the median pairwise
