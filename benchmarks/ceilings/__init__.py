"""Ceilings campaign: measure each tool's memory / time / quality size ceilings.

The published capability table carries three measured ceilings per tool (see the docs'
...
and the stage drivers that turn raw run records into ceiling values.
"""
