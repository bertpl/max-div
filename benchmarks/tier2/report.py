...
# Budget points the margin tables quote (seconds; matched to the nearest value of the series).
...
def maxdiv_mean_at_budget(records: list[RunRecord], metric_name: str, budget_sec: float) -> float | None:
    """Mean quality over seeds of the max-div run optimizing the metric, at the given budget point."""
