...
from max_div.solver._presets.default import preset_default_get_strategies
...
def test_preset_default_get_strategies_short(target_duration: TargetDuration, initialization_included: bool):
    ...
    # --- act ---------------------------------------------
    init_strat, optim_steps = preset_default_get_strategies(problem, target_duration, initialization_included)
...
def test_preset_default_get_strategies_invalid_duration():
    ...
    with pytest.raises(TypeError):
        _ = preset_default_get_strategies("dummy_problem", "invalid_duration_type")
