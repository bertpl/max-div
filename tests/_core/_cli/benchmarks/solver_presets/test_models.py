from max_div._core._cli.benchmarks.solver_presets import results_from_json, results_to_json
from max_div._core._cli.benchmarks.solver_presets._executors import (
...
def test_params_parallel_fields():
    ...
    assert parallel.column_label() == "SMART (8 workers)"
