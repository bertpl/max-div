...
@pytest.mark.parametrize(
    ...
    [
        (InitializationStrategy.random_selection(), True),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([InitializationStrategy.random_selection()], False),
        ([InitializationStrategy.random_selection(), OptimizationStrategy.random_swaps()], False),
        ([OptimizationStrategy.random_swaps(), InitializationStrategy.random_selection()], False),
    ],
)
...
def test_max_div_solver_builder_end_to_end():
    ...
    vectors = np.random.rand(10, 5).astype(np.float32)
    k = 5
    init_strategy = InitializationStrategy.random_selection()
    solver_steps = [
