...
test:
	...
	uv run --all-extras --python 3.14 pytest ./tests --durations=10 --disable-warnings
...
coverage:
	...
	NUMBA_DISABLE_JIT=1 COVERAGE_FILE=./reports/.coverage uv run --all-extras --python 3.14 pytest ./tests --cov --cov-report=html:./reports/coverage --durations=10 --disable-warnings
