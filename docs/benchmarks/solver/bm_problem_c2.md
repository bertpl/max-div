...
![Problem C2](./images/problem_C2.png){ .center }
...
![Problem C2 with Solution](./images/problem_C2_with_solution.png){ .center }
...
![Problem C2 - Vector Separations](./images/problem_C2_separations.png){ .center75 }
