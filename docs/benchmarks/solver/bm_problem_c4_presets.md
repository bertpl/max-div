...
We present results of the different built-in solver presets on problem C4, size=100.  We run each preset for
...
![Problem C4 - Size 100 - Preset results](./images/preset_results_C4_100.webp)

### B. Tables

--8<-- "docs/benchmarks/solver/results/preset_result_quantiles_C4_100.md"
