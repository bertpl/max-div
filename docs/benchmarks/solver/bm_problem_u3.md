...
![Problem U3](./images/problem_U3.png){ .center }
...
![Problem U3 with Solution](./images/problem_U3_with_solution.png){ .center }
...
![Problem U3 - Vector Separations](./images/problem_U3_separations.png){ .center75 }
