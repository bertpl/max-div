...
*Stub — this page will be filled in as the quality-bound measurement results come in.*

## Best-Known Solutions

The **best-known solution** per problem size is the reference the quality verdicts are judged against. The values below come from the extended runs of the [measurement protocol](protocol.md) (section IV.D).
