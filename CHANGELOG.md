...
### Added
- A geometric-mean distance metric, `DistanceMetric.geometric_mean()`: the d-th root of the product of per-coordinate differences, which spreads a selection in every coordinate projection as well as in the full space (the pair distance of maximum projection designs, Joseph, Gul & Ba 2015)
