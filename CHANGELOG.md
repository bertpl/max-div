...
### Changed
- The comparison tables' single `max practical n` column is replaced by four measured solver-scaling values — memory, time, and quality at two gap-closure levels — each with a published definition
