...
![coverage](https://img.shields.io/badge/coverage-99.39%25-brightgreen)
![tests](https://img.shields.io/badge/tests-4704-blue)
...
<p align="center">
  <img src="https://raw.githubusercontent.com/bertpl/max-div/v0.17.5/images/splash_with_version.webp" alt="max-div logo" style="max-width: max(60%, min(100%,900px)); height: auto;">
</p>
...
- 📐 uniquely supports **7+ distance metrics** (L1, L2, L∞, Minkowski, cosine, geometric mean, single-dimension — or precomputed distances) and **4 diversity metrics** (minimum, mean & geomean separation + mean pairwise distance) in any combination
