...
![genbadge-test-count](https://bertpl.github.io/max-div/version_artifacts/release/v0.5.4/badge-test-count.svg)
![genbadge-test-coverage](https://bertpl.github.io/max-div/version_artifacts/release/v0.5.4/badge-coverage.svg)
...
<p>
  <img src="https://bertpl.github.io/max-div/version_artifacts/release/v0.5.4/splash.webp" alt="max-div logo" style="max-width: max(60%, min(100%,800px)); height: auto;">
</p>
