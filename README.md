...
![coverage](https://img.shields.io/badge/coverage-99.55%25-brightgreen)
![tests](https://img.shields.io/badge/tests-5008-blue)
...
<p align="center">
  <img src="https://raw.githubusercontent.com/bertpl/max-div/v0.18.2/images/splash_with_version.webp" alt="max-div logo" style="max-width: max(60%, min(100%,900px)); height: auto;">
</p>
