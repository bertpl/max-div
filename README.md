...
![genbadge-test-count](https://bertpl.github.io/max-div/version_artifacts/develop/v0.3.10/badge-test-count.svg)
![genbadge-test-coverage](https://bertpl.github.io/max-div/version_artifacts/develop/v0.3.10/badge-coverage.svg)
...
<p>
  <img src="https://bertpl.github.io/max-div/version_artifacts/develop/v0.3.10/splash.webp" alt="max-div logo" style="max-width: max(60%, min(100%,800px)); height: auto;">
</p>
