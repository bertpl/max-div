...
| geomean | Selects under the geometric-mean distance — the d-th root of the product of the per-coordinate differences, the pair distance of maximum projection designs (Joseph, Gul & Ba, 2015) — computed by the tool from vector input. |
