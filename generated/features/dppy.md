...
| distance metrics · L−∞ distance | <span class="mark mark-partial">◐</span> | [^dppy-1] |
| distance metrics · single-dimension distance | <span class="mark mark-partial">◐</span> | [^dppy-1] |
...
| diversity objectives · maximize the harmonic-mean nearest-neighbor separation | <span class="mark mark-none">—</span> | [^dppy-3] |
| diversity objectives · maximize the mean pairwise distance | <span class="mark mark-none">—</span> | [^dppy-3] |
| diversity objectives · combine several diversity terms over different distances | <span class="mark mark-none">—</span> | [^dppy-3] |
...
| solver scaling · largest n within memory | n = 500 | |
| solver scaling · largest n within the time budget | n = 500 | |
