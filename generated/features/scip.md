...
| distance metrics · L−∞ distance | <span class="mark mark-partial">◐</span> | [^scip-2] |
| distance metrics · single-dimension distance | <span class="mark mark-partial">◐</span> | [^scip-2] |
...
[^scip-6]: Reachable only by hand-building each term's objective and summing them into one, a formulation larger still than any single term's.
