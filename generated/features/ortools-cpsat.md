...
[^ortools-cpsat-6]: A feasibility-only solve of the hand-written constraint model returns a proven feasible-or-infeasible verdict; the proof machinery is native, the modeling is manual.
