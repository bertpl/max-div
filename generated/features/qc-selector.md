...
[^qc-selector-3]: The same Minkowski-exponent parameter that provides L1 and Chebyshev takes any p, forwarded to scipy by the radius-based methods; the greedy pickers accept a precomputed matrix or callable instead.
