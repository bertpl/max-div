...
class SolverState:
    ...
    def __init__(
        ...
        Problem Dimensions:
          ...
          ( n  : dimensionality of each vector  (not visible here, since we get pair-wise distances directly) )
        ...
        :param con_values: (np.ndarray[np.int32] | None) upper/lower bounds per constraint (nc x 2 array of float32)
